  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        {/* Title */}
        <h1 style={{ fontSize: '24px', fontWeight: 'normal', marginBottom: '4px' }}>
          Telltale
        </h1>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <h2 style={{ fontSize: '17px', fontWeight: 'normal', marginTop: '12px', marginBottom: '0' }}>
          ...
          <div style={{ marginTop: '8px' }}>
            <h2 style={{ fontSize: '17px', fontWeight: 'normal', marginBottom: '12px' }}>
